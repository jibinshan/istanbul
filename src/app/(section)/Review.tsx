...
const reviews: {
    ...
    stars: number;
}[] = [
        {
            name: "Anna Mathew",
            review:
                "Istanbul delivers an unforgettable steak experience! The food, service, and ambiance are second to none. We will definitely be coming back We booked private dining for our",
            stars: 5,
            date: "one day ago",
        ...
        },
        {
            name: "Mery Elza",
            review:
                "Best cuisine I've ever had! The quality of the meat was outstanding, and the truffle fries were to die for. Highly recommend!",
            stars: 5,
            date: "one day ago",
